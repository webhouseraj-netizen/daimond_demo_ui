...
export default function ManchProfile() {
  ...
  const roles = [
    { label: "संरक्षक :", name: "डॉ॰ चतुर्भुज, सिद्धेश्वरी प्रसाद सिंह उर्फ़ सिद्धि बाबू" },
