...
import { FaRegFileAlt, FaTv, FaBullhorn, FaRegCalendarAlt,FaVideo  } from "react-icons/fa";
...
export default function ServiceHero() {
    return (
        <section
            ...
            style={{
                backgroundImage: "url('https://bsmedia.business-standard.com/_media/bs/img/article/2020-06/26/full/1593189077-2974.jpg?im=FeatureCrop,size=(826,465)')",
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center pt-10 pb-2 w-full max-w-4xl min-h-auto">
                ...
                <p className="text-white text-lg max-w-2xl mb-10 text-center">
                    With 30 years of experience under its belt, Diamond Ads continues to set the standard
                    for excellence in the advertising industry, delivering comprehensive offline marketing solutions.
                </p>
                {/* Services */}
                <div className="flex flex-col md:flex-row justify-center gap-10 w-full">
                    ...
                    <div className="flex flex-col gap-4 items-center backdrop-blur-sm">
                        ...
                        <div className="font-medium text-[#21a0fa] text-base text-center">Print Media</div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 items-center backdrop-blur-sm">
                        ...
                        <div className="font-medium text-[#15a508] text-base text-center">Electronic Media</div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 items-center backdrop-blur-sm">
                        ...
                        <div className="font-medium text-[#ff7324] text-base text-center">Outdoor Publicity</div>
                    </div>
                    ...
                    <div className="flex flex-col gap-4 items-center backdrop-blur-sm">
                        ...
                        <div className="font-medium text-[#20db69] text-base text-center">Trade Fairs</div>
                    </div>
  ...
  <div className="font-medium text-blue-500 text-base text-center">Biopic Creation</div>
</div>
                </div>
